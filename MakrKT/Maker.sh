...
echo ""
read -p "What frequency do you want your radio tuned to? [97.1]: " frequency
[ -z $frequency ] && frequency=97.1
...
avrcommand="avrdude -qq -P usb -c $programmer -p attiny45 -b 15 -e -U flash:w:pr.hex -U eeprom:w:$tempfile"
while true; do
